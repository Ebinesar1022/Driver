...
! function() {
  ...
  var e = {
    ...
    i = {
      ...
      photo: ["Profile_Picture", "Profile Picture", "Profile_Photo", "Photo", "Driver_Photo",
  ...
  function P() {
    ...
    l && (l.className = "bfm__rest " + e.status, w("tripBfmRestText", e.restRequired ? e
        ...
        f(Math.max(0, e.shiftLeft)) + " left"), w("tripDriving", f(o.workedMins)), updateRestStamp();
  ...
  function Z() {
    ...
    e && (e.hidden = !!o.onBreak), t && (t.hidden = !o.onBreak), updateRestStamp()
  }
  ...
  function updateTripSummaryFields(e) {
    ...
    w("tripDistTotal", total && total > 0 ? "Of " + fmt(total) + " km total" : "Total distance not set"), w(
      "tripDistLeft", total && total > 0 && done && done > 0 ? fmt(Math.max(0, total - done)) : "—")
  }
    ...
    return ensurePdfLibs().then(function() {
      ...
      return window.html2canvas(doc, {
        ...
        onclone: function(clonedDoc) {
          ...
          cloneStamp && (opts && opts.stamp && (cloneStamp.src = POD_STAMP_SRC, cloneStamp.hidden = !1),
            cloneStamp.classList.remove("is-slam"), cloneStamp.style.animation = "none");
  ...
  function podShowCompletedStamp() {
    ...
    st && (st.getAttribute("src") || (st.src = POD_STAMP_SRC), st.hidden = !1, st.classList.remove("is-slam"),
      void st.offsetWidth, st.classList.add("is-slam"))
  }
  ...
  function saveDeliveryRecordToZoho() {
    ...
    (POD_RESULT_META.pdfUploaded ? Promise.resolve(null) : buildPodPdf(doc, {
      stamp: !0
    }).then(function(pdf) {
      ...
      if (result && result.preview) return done("Preview mode — POD not saved", !1, !0);
  ...
  function mr(e, t, r, n) {
    ...
    function cleanup() {
      i.removeEventListener("load", onLoad), i.removeEventListener("error", bad), clearTimeout(timer)
    }
    ...
    i.addEventListener("load", onLoad), i.addEventListener("error", bad), timer = setTimeout(function() {
      ...
      Ir = !0,
        function() {
          ...
          w("hdrDate", k()), w("hdrDriverId", s.id), document.addEventListener("click",
            ...
            }), e("#tripTimerBox", "click", openTripInfoPopup), e("#btnTripSummary", "click", openTripInfoPopup), e("#tripInfoClose", "click",
